...
int main()
{
	...
	cout<<"Enter  meter value:"; cin>>meters;
	cout<<endl;
	cout<<"Enter the number of conversions : "; cin>>iteration;
	cout<<endl;
	cout<<"Enter the increment  in meteric value: "; cin>>increment;
	cout<<endl;
	...
	if (iteration>10)
	{
		...
		cout<<"Iteration  would be less than 10..."<<endl;
